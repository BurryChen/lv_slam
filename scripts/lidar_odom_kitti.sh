...
#for seq in 01 03 04 05 06 07 08 09 10 02 00
#for seq in 03 
do
...
gnome-terminal -x bash -c "echo $seq;roslaunch LVO odom_kitti.launch res_dir:=$1 seq:=${seq} >$logfile &sleep 5s;rosbag play --clock /media/whu/HD_CHEN_2T/02data/KITTI_odometry/velobag/velo_${seq}.bag -r 0.7;echo $seq over&&sleep 25s;exit"
i=10#$seq
time=`expr 60 + ${durations[i+1]} \* 10 / 7`
echo $time s
sleep $time 
wait
