...
#include <local_odometry/ros_utils.hpp>
...
class LocalOdomertyNodelet : public nodelet::Nodelet {
public:
  typedef pcl::PointXYZI PointT;
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  LocalOdomertyNodelet() {}
  virtual  ~LocalOdomertyNodelet() 
  {
    fclose(fp_odom);
  ...
  virtual void onInit() {
    ...
    //sync->registerCallback(boost::bind(&LocalOdomertyNodelet::cloud_callback_sync, this, _1, _2));
    
    points_sub = nh.subscribe("/filtered_points", 256, &LocalOdomertyNodelet::cloud_callback, this);
...
PLUGINLIB_EXPORT_CLASS(lv_slam::LocalOdomertyNodelet, nodelet::Nodelet)